...
export function ProductDetails({ product, activeAccordion, toggleAccordion }: ProductDetailsProps) {
    ...
    return (
        ...
        <div className="flex flex-col gap-3 lg:gap-0">
            ...
            {product.productposters && product.productposters.length > 0 && (
                <div className="px-1 sm:px-2">
                    <ProductPosterSlider posters={product.productposters} />
                </div>
            )}
            ...
            <div className="space-y-1 px-3 sm:px-5">
                ...
                <div className="border-b border-zinc-200 dark:border-zinc-800">
                    ...
                    >
                        <span className="font-bold text-xl sm:text-2xl text-zinc-900 dark:text-white">Technical Specifications</span>
                            ...
                            >
                                ...
                                <div className="pb-8 space-y-8">
                                    ...
                                    {product.specs && product.specs.length > 0 ? product.specs.map((section, idx) => (
                                        ...
                                        <div key={idx} className="grid grid-cols-1 md:grid-cols-[160px_1fr] gap-4 md:gap-12 border-b border-zinc-200 dark:border-zinc-800 pb-3">
                ...
                <div className="border-b border-zinc-200 dark:border-zinc-800">
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-between py-6 text-left hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors px-2 -mx-2 rounded-lg hover:cursor-pointer"
                    >
                        <span className="font-bold text-xl sm:text-2xl text-zinc-900 dark:text-white">Geometry</span>
